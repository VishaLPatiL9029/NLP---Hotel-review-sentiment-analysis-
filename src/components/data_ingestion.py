...
class DataIngestion():
    ...
    def initiate_data_ingestion(self):
        ...
        try:
            ...
            os.makedirs(os.path.dirname(self.ingestion_config.raw_dat_path), exist_ok=True) # if the directory exist it does nothing, if its not there, it creates newone
            df.to_csv(self.ingestion_config.raw_dat_path, index = False)
